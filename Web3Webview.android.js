...
export default class WebView extends React.Component {
	...
	goForward = () => {
		UIManager.dispatchViewManagerCommand(this.getWebViewHandle(), UIManager.Web3Webview.Commands.goForward, null);
	};

	goBack = () => {
		UIManager.dispatchViewManagerCommand(this.getWebViewHandle(), UIManager.Web3Webview.Commands.goBack, null);
	};
	...
	reload = () => {
		...
		UIManager.dispatchViewManagerCommand(this.getWebViewHandle(), UIManager.Web3Webview.Commands.reload, null);
	};
	...
	postMessage = data => {
		UIManager.dispatchViewManagerCommand(this.getWebViewHandle(), UIManager.Web3Webview.Commands.postMessage, [
			String(data)
		]);
	};
